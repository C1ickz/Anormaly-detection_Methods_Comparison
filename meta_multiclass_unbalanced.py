'''
    ...
    @ single classifiers for meta-classifier are: decision tree, KNN, and SVM
...
plt.xticks([r + barWidth for r in range(len(fpr_dt))], ['0', '1', '2', '3', '4', '5', '6', '7'])
...
plt.subplots_adjust(bottom=0.1, top=0.84)
plt.xticks([r + barWidth for r in range(len(recall_dt))], ['0', '1', '2', '3', '4', '5', '6', '7'])
plt.legend(bbox_to_anchor=(0., 1.02, 1., .102), loc='lower left', ncol=2, mode="expand", borderaxespad=0.)
